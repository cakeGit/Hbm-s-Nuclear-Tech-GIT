...
public class RadiationConfig {
	...
	public static void loadFromConfig(Configuration config) {
		...
		worldRad = CommonConfig.createConfigInt(config, CATEGORY_NUKE, "6.12_worldRadCount", "How many block operations radiation can perform per tick", 10);
		worldRadThreshold = CommonConfig.createConfigInt(config, CATEGORY_NUKE, "6.13_worldRadThreshold", "The least amount of RADs required for block modification to happen", 40);
		worldRadEffects = CommonConfig.createConfigBool(config, CATEGORY_NUKE, "6.14_worldRadEffects", "Whether high radiation levels should perform changes in the world", true);
		// railgun
